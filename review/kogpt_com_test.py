...
if __name__ == "__main__":
    mode = 3
    data_path = "./dataset/score_test.xlsx"

    for i in range(1):

        list_result = []
        lr = (i+3) * 1e-05
        model_path = "./model/" + str(lr) + "/checkpoint-7000"
        excel_path = "./result/" + str(lr) + "_checkpoint-7000_mode3_no_score" + ".xlsx"
        test = Model_test(data_path, model_path, mode)
        test(excel_path)
        excel_path = "./result/" + str(lr) + "_checkpoint-7000_mode1_no_score" + ".xlsx"
        test = Model_test(data_path, model_path, 1)
        test(excel_path)
        excel_path = "./result/" + str(lr) + "_checkpoint-7000_mode2_no_score" + ".xlsx"
        test = Model_test(data_path, model_path, 2)
        test(excel_path)
        excel_path = "./result/" + str(lr) + "_checkpoint-7000_mode0_no_score" + ".xlsx"
        test = Model_test(data_path, model_path, 0)
        test(excel_path)

    data_path = "./dataset/score_test_2.xlsx"
    ...
    for i in range(1):
        ...
        lr = (i+3) * 1e-05
        model_path = "./model/" + str(lr) + "/checkpoint-7000"
        excel_path = "./result/" + str(lr) + "_checkpoint-7000_mode3_score" + ".xlsx"
        test = Model_test(data_path, model_path, mode)
        test(excel_path)
        data_path = "./dataset/score_test_3.xlsx"
        excel_path = "./result/" + str(lr) + "_checkpoint-7000_mode2_score" + ".xlsx"
        test = Model_test(data_path, model_path, 2)
        test(excel_path)
